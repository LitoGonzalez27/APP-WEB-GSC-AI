        ...
        <div class="project-card" data-project-id="${project.id}" onclick="manualAI.goToProjectAnalytics(${project.id})" style="cursor: pointer;">
            ...
            <div class="project-details">
                <div class="project-meta">
                    <span class="project-domain clickable-domain" title="Click to visit ${escapeHtml(project.domain)}" onclick="window.open('https://${escapeHtml(project.domain)}', '_blank')" style="cursor: pointer;">
