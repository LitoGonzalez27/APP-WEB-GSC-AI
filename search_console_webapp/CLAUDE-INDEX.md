...
| [`CLAUDE-enterprise-agencias.md`](./CLAUDE-enterprise-agencias.md) | ✅ | **Runbook clientes Enterprise / agencias** (2026-09): alta de un cliente con plan a medida, topes por módulo (`custom_*` en `users`), cuota y ciclo **por proyecto** (`project_quota.py`), cómo escalar cuando pide más proyectos, qué pasa al agotar, cómo verificar. Empieza aquí si Carlos dice "cliente enterprise", "agencia" o "accesos@albertopalazuelos.com". |
