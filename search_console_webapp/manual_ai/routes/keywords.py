...
from manual_ai.config import MAX_KEYWORDS_PER_PROJECT, EVENT_TYPES
from manual_ai.utils.validators import check_manual_ai_access
from enterprise_limits import MODULE_MANUAL_AI, get_effective_keywords_limit
...
def add_keywords_to_project(project_id):
    ...
    max_keywords = get_effective_keywords_limit(user, MODULE_MANUAL_AI, MAX_KEYWORDS_PER_PROJECT)
