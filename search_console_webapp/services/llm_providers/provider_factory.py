    ...
    def get_provider_info(cls) -> Dict[str, Dict]:
        ...
        return {
            'openai': {
                ...
                'models': ['gpt-5.4', 'gpt-5.4-pro', 'gpt-5.3-chat-latest', 'gpt-5-mini', 'gpt-4o'],
                'description': 'GPT-5.4: Último flagship de OpenAI, 128K context',
                'website': 'https://platform.openai.com',
                'pricing_note': 'GPT-5.4: $1.75/$14 per 1M tokens'
            },
            'anthropic': {
